...
typedef uint8_t XBox360_Byte;
typedef uint16_t XBox360_Short;
typedef int16_t XBox360_SShort;
...
// Structure describing the report had back from the wirless controller
typedef struct XBOX360W_IN_REPORT {
    XBox360_Byte padding[4];
    XBOX360_PACKET header;
    XBox360_Short buttons;
    XBox360_Byte trigL,trigR;
    XBOX360_HAT left,right;
